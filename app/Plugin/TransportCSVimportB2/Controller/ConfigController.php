...
use Plugin\TransportCSVimportB2\Form\Type\ConfigType;
    ...
    public function edit(Application $app, Request $request)
    {
        ...
        if ('POST' === $this->app['request']->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->app->redirect($this->app['url_generator']->generate('plugin_TransportCSVimportB2_config'));
            }
        }

        return $this->app['view']->render('TransportCSVimportB2/View/admin/transport_csv_import_b2_config.twig',
            array(
