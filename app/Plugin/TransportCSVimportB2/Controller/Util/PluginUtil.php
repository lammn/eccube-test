...
namespace Plugin\TransportCSVimportB2\Controller\Util;
...
class PluginUtil
{
    ...
    function getSubData($key = null)
    {
        ...
        $ret = $this->app['orm.em']->getRepository('Plugin\TransportCSVimportB2\Entity\TransportCSVimportB2Plugin')
    ...
    function registerSubData($data, $key = null)
    {
        ...
        $pluginCode = $this->getCode(true);
        $TransportCSVimportB2Plugin = $this->app['orm.em']->getRepository('Plugin\TransportCSVimportB2\Entity\TransportCSVimportB2Plugin')
            ->findOneBy(array('code' => $pluginCode));
        if (!is_null($TransportCSVimportB2Plugin)) {
            $TransportCSVimportB2Plugin->setSubData($subDataSer);
            $this->app['orm.em']->persist($TransportCSVimportB2Plugin);
