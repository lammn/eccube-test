 ...
 * OrderDetail
 */
class OrderPdfOrderDetail extends \Eccube\Entity\AbstractEntity
{
    ...
    /**
     * @var \Plugin\OrderPdf\Entity\Order
     */
    private $Order;
     ...
     * Set Order
     *
     * @param  \Plugin\OrderPdf\Entity\Order $order
     * @return OrderDetail
     */
    public function setOrder(\Plugin\OrderPdf\Entity\Order $order)
    {
        $this->Order = $order;
