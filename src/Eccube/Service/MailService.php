...
class MailService
{
    ...
    //入金済みメール
    public function sendPayOrderMail($Order)
    {
    	mb_language("japanese");
    	mb_internal_encoding("UTF-8");
    	
    	$to = $Order['email'];
    	$subject = "Latia online shop ご入金確認致しました。";
    	$from = "info@latia-story.com";
    	
    	
			$body = $this->app->renderView('Mail/pay.twig', array(
        'Order' => $Order,
      ));
    ...
    //発送済みメール
    public function sendDelivOrderMail($Order)
    {
    	mb_language("japanese");
    	mb_internal_encoding("UTF-8");
    	
    	$to = $Order['email'];
    	$subject = "Latia online shop 商品発送完了致しました。";
    	$from = "info@latia-story.com";
    	
    	$body = $this->app->renderView('Mail/deliv.twig', array(
        'Order' => $Order,
      ));
